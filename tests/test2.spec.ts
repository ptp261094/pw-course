...
test('test 2', async ({ page }) => {
    ...
    test.step("Navigate to Product Page and add to cart", async() =>{
        const productPage = new ProductPage(page);
        productPage.navigateToPlaywrightPage();
        productPage.clickProductPageButton();
        productPage.clickFirstProduct2Times();
        productPage.clickSecondProduct3Times();
        productPage.clickThirdProduct1Time();
    })
